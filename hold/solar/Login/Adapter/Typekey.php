 ...
 *
 */
class Auth_Login_Adapter_Typekey extends Solar_Auth_Login_Adapter
{
    /**
     *
     ...
     *
     */
    protected $_Solar_Auth_Login_Adapter_Typekey = array(
        'token'     => null,
        'window'    => 10,
        'cache'     => null,
     ...
     * @var string
     *
     * @see Solar_Auth_Login_Adapter_Typekey::isLoginValid()
     *
     * @see Solar_Auth_Login_Adapter_Typekey::_processLogin()
     *
     */
    protected $_msg;
     ...
     * @var string
     *
     * @see Solar_Auth_Login_Adapter_Typekey::_fetchKeyData()
     *
     */
    protected $_key;
