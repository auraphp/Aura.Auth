 ...
 *
 */
class Auth_Storage_Adapter_Post extends Solar_Auth_Storage_Adapter
{
    /**
     *
     ...
     *
     * @config string username The username element name.
     *
     * @config string password The password element name.
     *
